...
- Report a bug or request a new feature in our [issue tracker](https://github.com/PermafrostDiscoveryGateway/viz-points/issues)
...
viz-points is an open source project, and we welcome full
participation in the project.  Contributions are reviewed and suggestions are
made to increase the value of viz-points to the community.  We strive to
...
- add an [issue](https://github.com/PermafrostDiscoveryGateway/viz-points/issues) describing your planned changes, or add a comment to an existing issue;
- on GitHub, fork the [viz-points repository](https://github.com/PermafrostDiscoveryGateway/viz-points)
- on your computer, clone your forked copy of the viz-points repository
...
Development is managed through the git repository at https://github.com/PermafrostDiscoveryGateway/viz-points.  The repository is organized into several branches, each with a specific purpose.  
...
3. Releases can be downloaded from the [GitHub releases page](https://github.com/PermafrostDiscoveryGateway/viz-points/releases).

## Testing

**Unit and integration tests**. viz-points has a full suite of `pytest` tests in the `tests` subdirectory.
