...
def cli():
    ...
    parser.add_argument('-l', '--llvs', choices=[True, 'linear', 'quantile'], default=False, help='Whether to process a (lat, lon, displacement, stdev) CSV file and how to scale the resulting colors')
